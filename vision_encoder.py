...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor) -> torch.Tensor:
        ...
        input_images: [Batch_Size, 3, 224, 224]
        -> SiglipVisionEmbeddings # [Batch_Size, 196, 768]
        Outputs:
        -> embeddings_with_position: [Batch_Size, 196, 768] # [Batch_Size, Num_Patches, Embed_Dim]
        """
...
class SiglipMLP(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        input_embeds: [Batch_Size, Num_Patches, Hidden_Size]
        -> SiglipMLP # [Batch_Size, Num_Patches, Hidden_Size]
        Outputs:
...
class SiglipAttention(nn.Module):
    ...
    It follows the standard multi-head attention architecture from "Attention Is All You Need" with the following steps:
    ...
    The attention mechanism allows the model to attend to different parts of the input sequence simultaneously, capturing various types of relationships between patches in the image.
...
class SiglipEncoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        input_embeds: [Batch_Size, Num_Patches, Hidden_Size]
        -> SiglipEncoderLayer # [Batch_Size, Num_Patches, Hidden_Size]
        Outputs:
        -> hidden_states: [Batch_Size, Num_Patches, Hidden_Size]
        """
...
class SiglipEncoder(nn.Module):
    ...
    def forward(self, input_embeds: torch.Tensor) -> torch.Tensor:
        ...
        input_embeds: [Batch_Size, Num_Patches, Hidden_Size]
        -> SiglipEncoderLayer * num_layers # [Batch_Size, Num_Patches, Hidden_Size]
        Outputs:
        -> hidden_states: [Batch_Size, Num_Patches, Hidden_Size]
        """
...
class SiglipVisionTransformer(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor) -> torch.Tensor:
        ...
        input_images: [Batch_Size, 3, 224, 224]
        -> SiglipVisionEmbeddings # [Batch_Size, 196, 768]
        -> SiglipEncoder # [Batch_Size, 196, 768]
        -> SiglipVisionTransformer # [Batch_Size, 196, 768]
        Outputs:
        -> final_output: [Batch_Size, 196, 768] # [Batch_Size, Num_Patches, Embed_Dim]
        """
